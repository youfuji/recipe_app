...
declare const props: ("dir" | "id" | "max" | "min" | "value" | "orientation" | "getRootNode" | "ids" | "translations" | "onValueChange")[];
declare const splitProps: <Props extends Partial<UserDefinedContext>>(props: Props) => [Partial<UserDefinedContext>, Omit<Props, "dir" | "id" | "max" | "min" | "value" | "orientation" | "getRootNode" | "ids" | "translations" | "onValueChange">];

export { type MachineApi as Api, type UserDefinedContext as Context, type ElementIds, type IntlTranslations, type ProgressState, type Service, type ValueChangeDetails, type ValueTranslationDetails, type ViewProps, anatomy, connect, machine, props, splitProps };

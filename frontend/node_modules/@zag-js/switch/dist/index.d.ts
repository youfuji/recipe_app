...
declare const props: ("label" | "disabled" | "form" | "dir" | "id" | "checked" | "name" | "value" | "required" | "getRootNode" | "invalid" | "ids" | "readOnly" | "onCheckedChange")[];
declare const splitProps: <Props extends Partial<UserDefinedContext>>(props: Props) => [Partial<UserDefinedContext>, Omit<Props, "label" | "disabled" | "form" | "dir" | "id" | "checked" | "name" | "value" | "required" | "getRootNode" | "invalid" | "ids" | "readOnly" | "onCheckedChange">];

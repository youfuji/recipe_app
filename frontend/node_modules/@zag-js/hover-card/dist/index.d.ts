...
declare const anatomy: _zag_js_anatomy.AnatomyInstance<"arrow" | "arrowTip" | "trigger" | "positioner" | "content">;
...
declare const props: ("open" | "dir" | "id" | "getRootNode" | "ids" | "onOpenChange" | "openDelay" | "closeDelay" | "open.controlled" | "positioning")[];
declare const splitProps: <Props extends Partial<UserDefinedContext>>(props: Props) => [Partial<UserDefinedContext>, Omit<Props, "open" | "dir" | "id" | "getRootNode" | "ids" | "onOpenChange" | "openDelay" | "closeDelay" | "open.controlled" | "positioning">];

...
declare const props: ("disabled" | "form" | "dir" | "id" | "autoFocus" | "name" | "value" | "required" | "getRootNode" | "ids" | "translations" | "count" | "readOnly" | "allowHalf" | "onValueChange" | "onHoverChange")[];
declare const splitProps: <Props extends Partial<UserDefinedContext>>(props: Props) => [Partial<UserDefinedContext>, Omit<Props, "disabled" | "form" | "dir" | "id" | "autoFocus" | "name" | "value" | "required" | "getRootNode" | "ids" | "translations" | "count" | "readOnly" | "allowHalf" | "onValueChange" | "onHoverChange">];

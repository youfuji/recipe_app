    ...
    },
    {
      activities: {
        preventDocumentDrop(ctx2) {
          ...
          const onDrop = (event) => {
            if (domQuery.contains(dom.getRootEl(ctx2), domQuery.getEventTarget(event))) return;
            event.preventDefault();
          };
      ...
      actions: {
        ...
        removeFile(ctx2, evt) {
          ...
          ctx2.acceptedFiles = core.ref(files);
          ctx2.rejectedFiles = core.ref(rejectedFiles);
          invoke.change(ctx2);
        },

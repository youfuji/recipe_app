...
var colorMix = require('./styled-system/color-mix.cjs');
var config = require('./styled-system/config.cjs');
var cssVar = require('./styled-system/css-var.cjs');
...
const divideColor = colorMix.createColorMixTransform("borderColor");
...
const defaultConditions = config.defineConditions({
  hover: [
    "@media (hover: hover)",
  ...
  utilities: {
    ...
    background: {
      ...
      transform(value, args) {
        ...
        const styleObj = colorMix.createColorMixTransform("background")(value, args);
    ...
    backgroundColor: {
      ...
      transform(value, args) {
        ...
        const styleObj = colorMix.createColorMixTransform("backgroundColor")(value, args);
        return {
          ...styleObj,
    ...
    gradientFrom: {
      values: colorValues,
      transform: colorMix.createColorMixTransform("--gradient-from")
    },
    gradientTo: {
      values: colorValues,
      transform: colorMix.createColorMixTransform("--gradient-to")
    },
    gradientVia: {
      values: colorValues,
      transform(value, args) {
        const styles = colorMix.createColorMixTransform("--gradient-via")(value, args);
        return {
          ...styles,
    ...
    borderColor: {
      values: colorValues,
      transform: colorMix.createColorMixTransform("borderColor")
    },
    borderTopColor: {
      values: colorValues,
      transform: colorMix.createColorMixTransform("borderTopColor")
    },
    borderBlockStartColor: {
      values: colorValues,
      transform: colorMix.createColorMixTransform("borderBlockStartColor")
    },
    borderBottomColor: {
      values: colorValues,
      transform: colorMix.createColorMixTransform("borderBottomColor")
    },
    borderBlockEndColor: {
      values: colorValues,
      transform: colorMix.createColorMixTransform("borderBlockEndColor")
    },
    borderLeftColor: {
      values: colorValues,
      transform: colorMix.createColorMixTransform("borderLeftColor")
    },
    borderInlineStartColor: {
      values: colorValues,
      shorthand: ["borderStartColor"],
      transform: colorMix.createColorMixTransform("borderInlineStartColor")
    },
    borderRightColor: {
      values: colorValues,
      transform: colorMix.createColorMixTransform("borderRightColor")
    },
    borderInlineEndColor: {
      values: colorValues,
      shorthand: ["borderEndColor"],
      transform: colorMix.createColorMixTransform("borderInlineEndColor")
    },
    // border styles
    ...
    color: {
      values: colorValues,
      transform: colorMix.createColorMixTransform("color")
    },
    fill: {
      values: colorValues,
      transform: colorMix.createColorMixTransform("fill")
    },
    stroke: {
      values: colorValues,
      transform: colorMix.createColorMixTransform("stroke")
    },
    accentColor: {
      values: colorValues,
      transform: colorMix.createColorMixTransform("accentColor")
    },
    // divide
    divideX: {
      values: { type: "string" },
    ...
    boxShadowColor: {
      values: colorValues,
      transform: colorMix.createColorMixTransform("--shadow-color"),
    ...
    outlineColor: {
      values: colorValues,
      transform: colorMix.createColorMixTransform("outlineColor")
    },
    ...
    focusRingColor: {
      values: colorValues,
      transform: colorMix.createColorMixTransform("--focus-ring-color")
    },
    focusRingOffset: {
      values: "spacing",
    ...
    scrollbarColor: {
      values: colorValues,
      transform: colorMix.createColorMixTransform("scrollbarColor")
    },
    ...
    ringColor: {
      values: colorValues,
      transform: colorMix.createColorMixTransform("--ring-color")
    },
    ringOffset: {
    ...
    ringOffsetColor: {
      values: colorValues,
      transform: colorMix.createColorMixTransform("--ring-offset-color")
    },
    ringInset: {
    ...
    textDecorationColor: {
      values: colorValues,
      transform: colorMix.createColorMixTransform("textDecorationColor")
    },
    ...
    caretColor: {
      values: colorValues,
      transform: colorMix.createColorMixTransform("caretColor")
    },
